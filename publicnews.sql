...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2021 at 05:07 PM
...
(1, 'QKZ8CJOTIZ', '3JRWBWNF46G506941DNB1ZHITHQDXW', 'https://static.toiimg.com/thumb/imgsize-656719,msid-83731668,width-400,resizemode-4/83731668.jpg', 'Krishnakumar pal', 'This is corona virus', 'India', 'Health', '2021-06-24'),
...
(5, 'QKZ8CJOTIZ', 'ALETDT61DWOBE8OWX1DL09YPK1BGF7', 'https://i.guim.co.uk/img/media/c538df5440188f2ec8d28b0496d4f9d20cbd40aa/0_0_4267_2560/master/4267.jpg?width=620&quality=85&auto=format&fit=max&s=4f4839cf407b23cf956d85f80e60ea21', 'No 10 says mass event pilot findings for England will be published ‘shortly’', 'Downing Street has said the government will publish the evidence gathered from piloting mass events such as concerts and festivals “shortly”, as music industry figures including Andrew Lloyd Webber take legal action in an effort to force its disclosure.\r\n\r\nLloyd Webber is among a group of people including the impresario Cameron Mackintosh who have instigated legal proceedings against the government over its events research programme.\r\n\r\nSome of the pilot events, which have included the Download music festival, the snooker world championships and a club night in Liverpool, took place as long ago as April and government sources say the results have been encouraging.\r\n\r\nMusic industry figures believe No 10 has been reluctant to publish the results for fear of cutting across the cautious messaging it has stuck to since delaying the 21 June reopening.\r\n\r\n“We simply must now see the data that is being used to strangle our industry so unfairly,” Lloyd Webber said in a statement. “The government’s actions are forcing theatre and music companies off a cliff as the summer wears on, whilst cherrypicking high-profile sporting events to go ahead. The situation is beyond urgent.”', 'America', 'Health', '2021-06-23'),
...
CREATE TABLE `profile_info` (
  ...
  `Reading_list` varchar(100) DEFAULT NULL,
  `Follower` varchar(150) DEFAULT NULL,
  `Followed` varchar(150) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `profile_info` (`id`, `ID_Number`, `Name`, `Bio`, `Country`, `Phone_no`, `Email`, `Profile_img`, `Reading_list`, `Follower`, `Followed`) VALUES
(3, 'QKZ8CJOTIZ', 'Krishna Pal', 'Hii my name is Krishna', 'India', '+918318031071', 'Krishnapal2545@gmail.com', 'kk.png', NULL, NULL, NULL),
(4, 'MFU4CQDRYG', 'Sumit Rajendra Vishwakarama', 'hiii', 'America', '8828081171', 'SumitVish@gmail.com', NULL, NULL, NULL, NULL),
(5, 'RW8AG9RN38', 'Chetan Prajapat', 'my name is chetna I love coding', 'Africa', '+918318031071', 'Chetan@gmail.com', 'user3.png', NULL, NULL, NULL),
(6, 'LPJ41OOMNB', 'Meera Devi Pal', 'Hii I am mother of Mr. KrishnaKumar Pal', 'Bangladesh', '9819753541', 'Palmeera2087@gmail.com', NULL, NULL, NULL, NULL);
